  ...
  return (
    <div className="page1" style={{ height: "unset" }}>
      ...
      <h3 className="paragraph">
        ...
        &nbsp;to discover a diverse range of applications and technologies.
      </h3>
    </div>
  );
};
